...
base class MultiPolylineLayer<R extends Object>
  ...
  /// [Crs.replicatesWorldLongitude], multiPolylines will still be repeated across
...
class _PolylineLayerState<R extends Object> extends State<MultiPolylineLayer<R>>
    with
  ...
  Iterable<_ProjectedPolyline<R>> _aggressivelyCullPolylines({
    ...
    for (final projectedPolyline in polylines) {
      ...
      for (int i = 0; i < projectedPolyline.points.length - 1; i++) {
        ...
        containsSegment = projBounds.aabbContainsLine(
          p1.dx,
          p1.dy,
          p2.dx,
          p2.dy,
